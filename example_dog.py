...
plt.axis('off')
plt.savefig("result_toy/groundtruthRGBimage.png", bbox_inches='tight')
plt.savefig("result_toy/groundtruthRGBimage.svg", dpi=300, format='svg',
            bbox_inches='tight')
...
plt.axis('off')
plt.savefig("result_toy/edge.png", bbox_inches='tight')
plt.savefig("result_toy/edge.svg", dpi=300, format='svg',
            bbox_inches='tight')
...
for i in range(23):
    ...
    single_wavelength_hsi[...,i+3] = reconstructed_hsi[...,i+3] * 6
...
plt.savefig("result_toy/hsi.png", bbox_inches='tight')
plt.savefig("result_toy/hsi.svg", dpi=300, format='svg',
            bbox_inches='tight')
...
plt.ylim(0)
plt.savefig("result_toy/nose_spectrum.png", bbox_inches='tight')
plt.savefig("result_toy/nose_spectrum.svg", dpi=300, format='svg',
            bbox_inches='tight')
...
plt.ylabel("Radiance", fontsize=14)
plt.ylim(0)
plt.savefig("result_toy/foot_spectrum.png", bbox_inches='tight')
plt.savefig("result_toy/foot_spectrum.svg", dpi=300, format='svg',
            bbox_inches='tight')
...
plt.axis('off')
ax = plt.gca()
rect = patches.Rectangle((50,208), 10, 10, fill=False, edgecolor = 'red',linewidth=2)
ax.add_patch(rect)
rect = patches.Rectangle((128,120), 10, 10, fill=False, edgecolor = 'red',linewidth=2)
ax.add_patch(rect)
plt.savefig("result_toy/mark.png", bbox_inches='tight')
plt.savefig("result_toy/mark.svg", dpi=300, format='svg',
            bbox_inches='tight')
